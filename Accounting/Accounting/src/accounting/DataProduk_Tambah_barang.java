 ...
 * @author klemu
 */
public class DataProduk_Tambah_barang extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public DataProduk_Tambah_barang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataProduk_Tambah_barang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataProduk_Tambah_barang().setVisible(true);
            }
        });
    }
