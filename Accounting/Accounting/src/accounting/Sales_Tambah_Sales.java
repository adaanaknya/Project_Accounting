 ...
 * @author klemu
 */
public class Sales_Tambah_Sales extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public Sales_Tambah_Sales() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sales_Tambah_Sales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sales_Tambah_Sales().setVisible(true);
            }
        });
    }
