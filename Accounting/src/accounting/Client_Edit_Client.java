 ...
 * @author klemu
 */
public class Client_Edit_Client extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public Client_Edit_Client() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client_Edit_Client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client_Edit_Client().setVisible(true);
            }
        });
    }
