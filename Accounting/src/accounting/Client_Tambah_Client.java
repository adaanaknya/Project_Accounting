 ...
 * @author klemu
 */
public class Client_Tambah_Client extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public Client_Tambah_Client() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client_Tambah_Client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client_Tambah_Client().setVisible(true);
            }
        });
    }
