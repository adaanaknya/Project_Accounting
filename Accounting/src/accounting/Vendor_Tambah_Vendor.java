 ...
 * @author klemu
 */
public class Vendor_Tambah_Vendor extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public Vendor_Tambah_Vendor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vendor_Tambah_Vendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendor_Tambah_Vendor().setVisible(true);
            }
        });
    }
